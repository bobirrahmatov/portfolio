                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-1 md:left-1 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                            ...
                            <div className="flex flex-col mt-4">
                                ...
                                <h4 className="hidden md:block text-xs md:pl-20 md:text-xs font-bold text-neutral-500 dark:text-neutral-500 ">
                                    {item.subtitle}
                                </h4>
                            </div>
                        </div>
