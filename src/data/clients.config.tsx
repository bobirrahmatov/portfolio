...
export const CLIENTWORKS = [
  ...
  {
    title: "inVerus",
    dates: "20 Dec 2024 - 2nd Jan 2024",
    worktype: "Website, Platform",
    testimonial:
      "",
    featured: true,
    description:
      "inVerus is a platform dedicated to the next evolution in identity fraud prevention, leveraging AI-driven solutions to combat deep fakes and escalating attacks, protecting businesses from the $43 billion annual threat of identity fraud.",
    features:
      "",
    technologies: [
      "Next.js",
    ...
    links: [
      {
        type: "Website",
        href: "https://inverus.vercel.app/",
        icon: <Icons.globe className="size-3" />,
      },
    ],
    image: "https://firebasestorage.googleapis.com/v0/b/portfolio-e69c5.firebasestorage.app/o/undefined.png?alt=media&token=ce6c7abc-84ed-47b5-8df9-19baad918be9",
    video: ""
  },
  {
